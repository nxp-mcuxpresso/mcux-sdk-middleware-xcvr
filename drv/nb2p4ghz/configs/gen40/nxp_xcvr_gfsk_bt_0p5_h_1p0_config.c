...
const xcvr_mode_datarate_config_t xcvr_gfsk_bt_0p5_h_1p0_1mbps_config = {
    ...
    .fsk_cfg1 = GEN4PHY_FSK_CFG1_OVERH(0x080) | GEN4PHY_FSK_CFG1_OVERH_INV(0x080) | GEN4PHY_FSK_CFG1_SYNCTSCALE(0xF),
...
#if RF_OSC_26MHZ == 1
    .acq_filt_10_11_drs = XCVR_RX_DIG_ACQ_FILT_10_11_DRS_H10(0x0054) | XCVR_RX_DIG_ACQ_FILT_10_11_DRS_H11(0x00E4),
#else
...
/* ACQ_FILT_4_7_DRS configuration, dependencies: ['MD+DR', 'MD+DR', 'MD+DR', 'MD+DR'] */
    ...
    .acq_filt_4_7_drs = XCVR_RX_DIG_ACQ_FILT_4_7_DRS_H4(0xFFFC) | XCVR_RX_DIG_ACQ_FILT_4_7_DRS_H5(0x0005) |
                        XCVR_RX_DIG_ACQ_FILT_4_7_DRS_H6(0x0015) | XCVR_RX_DIG_ACQ_FILT_4_7_DRS_H7(0x0004),
#else
...
#if RF_OSC_26MHZ == 1
    .acq_filt_8_9_drs = XCVR_RX_DIG_ACQ_FILT_8_9_DRS_H8(0xFFD2) | XCVR_RX_DIG_ACQ_FILT_8_9_DRS_H9(0xFFD7),
#else
