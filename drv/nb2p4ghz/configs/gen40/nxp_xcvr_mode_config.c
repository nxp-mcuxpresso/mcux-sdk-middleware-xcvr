...
xcvrStatus_t XCVR_RadioGenRegSetup(const xcvr_config_t *xcvr_config)
{
    ...
    if (xcvr_config != NULLPTR)
    {
        ...
        GEN4PHY->FSK_CFG2                    = mode_datarate_cfg->fsk_cfg2 | common_cfg->fsk_cfg2;
        GEN4PHY->FSK_CFG3                    = mode_datarate_cfg->fsk_cfg3;
        ...
        XCVR_ANALOG->PLL       = common_cfg->pll | mode_datarate_cfg->pll;
        ...
        XCVR_PLL_DIG->CTUNE_CTRL           = common_cfg->ctune_ctrl;
        ...
        XCVR_PLL_DIG->HPMCAL_CTRL          = common_cfg->hpmcal_ctrl;
        ...
        XCVR_RX_DIG->AGC_IDX11_GAIN_CFG = common_cfg->agc_idx11_gain_cfg;
        XCVR_RX_DIG->AGC_IDX11_GAIN_VAL = common_cfg->agc_idx11_gain_val;
        ...
        XCVR_RX_DIG->AGC_TIMING0_DRS    = mode_datarate_cfg->agc_timing0_drs;
        ...
        XCVR_RX_DIG->AGC_TIMING2        = mode_datarate_cfg->agc_timing2;
        ...
        XCVR_RX_DIG->RSSI_GLOBAL_CTRL   = common_cfg->rssi_global_ctrl;
