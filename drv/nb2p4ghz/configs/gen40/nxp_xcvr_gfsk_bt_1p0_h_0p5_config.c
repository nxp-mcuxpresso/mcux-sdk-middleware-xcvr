...
#if RF_OSC_26MHZ == 1
    .acq_filt_0_3 = XCVR_RX_DIG_ACQ_FILT_0_3_H0(0xFFFE) | XCVR_RX_DIG_ACQ_FILT_0_3_H1(0x0004) |
                    XCVR_RX_DIG_ACQ_FILT_0_3_H2(0x000D) | XCVR_RX_DIG_ACQ_FILT_0_3_H3(0x0010),
#else
...
#if RF_OSC_26MHZ == 1
    .acq_filt_0_3_drs = XCVR_RX_DIG_ACQ_FILT_0_3_DRS_H0(0x0006) | XCVR_RX_DIG_ACQ_FILT_0_3_DRS_H1(0x000A) |
                        XCVR_RX_DIG_ACQ_FILT_0_3_DRS_H2(0x000A) | XCVR_RX_DIG_ACQ_FILT_0_3_DRS_H3(0x0003),
#else
    .acq_filt_0_3_drs = XCVR_RX_DIG_ACQ_FILT_0_3_DRS_H0(0x0001) | XCVR_RX_DIG_ACQ_FILT_0_3_DRS_H1(0xFFFE) |
                        XCVR_RX_DIG_ACQ_FILT_0_3_DRS_H2(0xFFF8) | XCVR_RX_DIG_ACQ_FILT_0_3_DRS_H3(0xFFFB),
#endif /* RF_OSC_26MHZ == 1 */

/* ACQ_FILT_10_11 configuration, dependencies: ['MD+DR', 'MD+DR'] */
#if RF_OSC_26MHZ == 1
    .acq_filt_10_11 = XCVR_RX_DIG_ACQ_FILT_10_11_H10(0x006C) | XCVR_RX_DIG_ACQ_FILT_10_11_H11(0x0094),
#else
    .acq_filt_10_11     = XCVR_RX_DIG_ACQ_FILT_10_11_H10(0x0061) | XCVR_RX_DIG_ACQ_FILT_10_11_H11(0x00EC),
#endif /* RF_OSC_26MHZ == 1 */

/* ACQ_FILT_10_11_DRS configuration, dependencies: ['MD+DR', 'MD+DR'] */
#if RF_OSC_26MHZ == 1
    .acq_filt_10_11_drs = XCVR_RX_DIG_ACQ_FILT_10_11_DRS_H10(0x0067) | XCVR_RX_DIG_ACQ_FILT_10_11_DRS_H11(0x0081),
#else
    .acq_filt_10_11_drs = XCVR_RX_DIG_ACQ_FILT_10_11_DRS_H10(0x006E) | XCVR_RX_DIG_ACQ_FILT_10_11_DRS_H11(0x00D1),
#endif /* RF_OSC_26MHZ == 1 */

/* ACQ_FILT_4_7 configuration, dependencies: ['MD+DR', 'MD+DR', 'MD+DR', 'MD+DR'] */
#if RF_OSC_26MHZ == 1
    .acq_filt_4_7 = XCVR_RX_DIG_ACQ_FILT_4_7_H4(0x0006) | XCVR_RX_DIG_ACQ_FILT_4_7_H5(0xFFF3) |
                    XCVR_RX_DIG_ACQ_FILT_4_7_H6(0xFFDF) | XCVR_RX_DIG_ACQ_FILT_4_7_H7(0xFFDE),
#else
    .acq_filt_4_7       = XCVR_RX_DIG_ACQ_FILT_4_7_H4(0xFFF9) | XCVR_RX_DIG_ACQ_FILT_4_7_H5(0x0014) |
                    XCVR_RX_DIG_ACQ_FILT_4_7_H6(0x0021) | XCVR_RX_DIG_ACQ_FILT_4_7_H7(0xFFF7),
#endif /* RF_OSC_26MHZ == 1 */

/* ACQ_FILT_4_7_DRS configuration, dependencies: ['MD+DR', 'MD+DR', 'MD+DR', 'MD+DR'] */
#if RF_OSC_26MHZ == 1
    .acq_filt_4_7_drs = XCVR_RX_DIG_ACQ_FILT_4_7_DRS_H4(0xFFF5) | XCVR_RX_DIG_ACQ_FILT_4_7_DRS_H5(0xFFE8) |
                        XCVR_RX_DIG_ACQ_FILT_4_7_DRS_H6(0xFFE3) | XCVR_RX_DIG_ACQ_FILT_4_7_DRS_H7(0xFFF0),
#else
    .acq_filt_4_7_drs = XCVR_RX_DIG_ACQ_FILT_4_7_DRS_H4(0x000C) | XCVR_RX_DIG_ACQ_FILT_4_7_DRS_H5(0x0019) |
                        XCVR_RX_DIG_ACQ_FILT_4_7_DRS_H6(0x0009) | XCVR_RX_DIG_ACQ_FILT_4_7_DRS_H7(0xFFDD),
#endif /* RF_OSC_26MHZ == 1 */

/* ACQ_FILT_8_9 configuration, dependencies: ['MD+DR', 'MD+DR'] */
#if RF_OSC_26MHZ == 1
    .acq_filt_8_9 = XCVR_RX_DIG_ACQ_FILT_8_9_H8(0xFFFA) | XCVR_RX_DIG_ACQ_FILT_8_9_H9(0x0030),
#else
    .acq_filt_8_9     = XCVR_RX_DIG_ACQ_FILT_8_9_H8(0xFFBD) | XCVR_RX_DIG_ACQ_FILT_8_9_H9(0xFFD7),
#endif /* RF_OSC_26MHZ == 1 */

/* ACQ_FILT_8_9_DRS configuration, dependencies: ['MD+DR', 'MD+DR'] */
#if RF_OSC_26MHZ == 1
    .acq_filt_8_9_drs = XCVR_RX_DIG_ACQ_FILT_8_9_DRS_H8(0x000F) | XCVR_RX_DIG_ACQ_FILT_8_9_DRS_H9(0x003C),
#else
    .acq_filt_8_9_drs = XCVR_RX_DIG_ACQ_FILT_8_9_DRS_H8(0xFFC7) | XCVR_RX_DIG_ACQ_FILT_8_9_DRS_H9(0xFFFA),
#endif /* RF_OSC_26MHZ == 1 */
...
/* DEMOD_FILT_2_4 configuration, dependencies: ['MD+DR', 'MD+DR', 'MD+DR'] */
    ...
    .demod_filt_2_4_drs = XCVR_RX_DIG_DEMOD_FILT_2_4_DRS_H2(0x001E) | XCVR_RX_DIG_DEMOD_FILT_2_4_DRS_H3(0x0086) |
...
#if RF_OSC_26MHZ == 1
    .gfsk_coeff_2_3 = XCVR_TX_DIG_GFSK_COEFF_2_3_GFSK_COEFF_2(0x003) | XCVR_TX_DIG_GFSK_COEFF_2_3_GFSK_COEFF_3(0x010),
#else
...
#if RF_OSC_26MHZ == 1
    .gfsk_coeff_4_5 = XCVR_TX_DIG_GFSK_COEFF_4_5_GFSK_COEFF_4(0x03C) | XCVR_TX_DIG_GFSK_COEFF_4_5_GFSK_COEFF_5(0x0A5),
#else
    .gfsk_coeff_4_5 = XCVR_TX_DIG_GFSK_COEFF_4_5_GFSK_COEFF_4(0x003) | XCVR_TX_DIG_GFSK_COEFF_4_5_GFSK_COEFF_5(0x030),
#endif /* RF_OSC_26MHZ == 1 */

/* GFSK_COEFF_6_7 configuration, dependencies: ['MD+DR', 'MD+DR'] */
#if RF_OSC_26MHZ == 1
    .gfsk_coeff_6_7 = XCVR_TX_DIG_GFSK_COEFF_6_7_GFSK_COEFF_6(0x145) | XCVR_TX_DIG_GFSK_COEFF_6_7_GFSK_COEFF_7(0x1C7),
#else
    .gfsk_coeff_6_7 = XCVR_TX_DIG_GFSK_COEFF_6_7_GFSK_COEFF_6(0x11B) | XCVR_TX_DIG_GFSK_COEFF_6_7_GFSK_COEFF_7(0x2B1),
#endif /* RF_OSC_26MHZ == 1 */
