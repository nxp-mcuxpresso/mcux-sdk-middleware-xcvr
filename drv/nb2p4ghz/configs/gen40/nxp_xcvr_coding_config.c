...
const xcvr_coding_config_t xcvr_ble_coded_s2_config = {
    ...
    .dmd_ctrl1 = GEN4PHY_DMD_CTRL1_FED_IDLE_WIN(0x0008) | GEN4PHY_DMD_CTRL1_FED_IMM_MEAS_EN(1) |
                 GEN4PHY_DMD_CTRL1_TED_ERR_SCALE(0x04) | GEN4PHY_DMD_CTRL1_TED_IDLE_WIN(0x0004) |
                 GEN4PHY_DMD_CTRL1_TED_IMM_MEAS_EN(1) | GEN4PHY_DMD_CTRL1_TTRK_INT_RANGE(0x03),
