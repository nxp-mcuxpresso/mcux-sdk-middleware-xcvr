...
/* workaround to fix error in SDK header files */
#define GEN4PHY_FSK_PD_PH_REF0 GEN4PHY_FSK_PD_PH_ref0
#define GEN4PHY_FSK_PD_PH_REF1 GEN4PHY_FSK_PD_PH_ref1
#define GEN4PHY_FSK_PD_PH_REF2 GEN4PHY_FSK_PD_PH_ref2
#define GEN4PHY_FSK_PD_PH_REF3 GEN4PHY_FSK_PD_PH_ref3

/* workaround to fix error in SDK header files */
#define GEN4PHY_LR_PD_PH_REF0 GEN4PHY_LR_PD_PH_ref0
#define GEN4PHY_LR_PD_PH_REF1 GEN4PHY_LR_PD_PH_ref1
#define GEN4PHY_LR_PD_PH_REF2 GEN4PHY_LR_PD_PH_ref2
#define GEN4PHY_LR_PD_PH_REF3 GEN4PHY_LR_PD_PH_ref3
