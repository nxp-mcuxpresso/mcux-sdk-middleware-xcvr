...
#include "nxp_xcvr_gfsk_bt_0p7_h_0p5_config.h"
...
#if RF_OSC_26MHZ == 1
    .acq_filt_0_3 = XCVR_RX_DIG_ACQ_FILT_0_3_H0(0xFFFF) | XCVR_RX_DIG_ACQ_FILT_0_3_H1(0x0001) |
                    XCVR_RX_DIG_ACQ_FILT_0_3_H2(0x0007) | XCVR_RX_DIG_ACQ_FILT_0_3_H3(0x000B),
#else
    .acq_filt_0_3         = XCVR_RX_DIG_ACQ_FILT_0_3_H0(0x0001) | XCVR_RX_DIG_ACQ_FILT_0_3_H1(0x0004) |
                    XCVR_RX_DIG_ACQ_FILT_0_3_H2(0xFFFF) | XCVR_RX_DIG_ACQ_FILT_0_3_H3(0xFFF5),
#endif /* RF_OSC_26MHZ == 1 */
...
/* ACQ_FILT_0_3_DRS configuration, dependencies: ['MD+DR', 'MD+DR', 'MD+DR', 'MD+DR'] */
    ...
    .acq_filt_0_3_drs = XCVR_RX_DIG_ACQ_FILT_0_3_DRS_H0(0x0001) | XCVR_RX_DIG_ACQ_FILT_0_3_DRS_H1(0x0005) |
                        XCVR_RX_DIG_ACQ_FILT_0_3_DRS_H2(0x0009) | XCVR_RX_DIG_ACQ_FILT_0_3_DRS_H3(0x0008),
#else
...
#if RF_OSC_26MHZ == 1
    .acq_filt_10_11 = XCVR_RX_DIG_ACQ_FILT_10_11_H10(0x0069) | XCVR_RX_DIG_ACQ_FILT_10_11_H11(0x0090),
#else
    .acq_filt_10_11     = XCVR_RX_DIG_ACQ_FILT_10_11_H10(0x0061) | XCVR_RX_DIG_ACQ_FILT_10_11_H11(0x00E1),
#endif /* RF_OSC_26MHZ == 1 */

/* ACQ_FILT_10_11_DRS configuration, dependencies: ['MD+DR', 'MD+DR'] */
#if RF_OSC_26MHZ == 1
    .acq_filt_10_11_drs = XCVR_RX_DIG_ACQ_FILT_10_11_DRS_H10(0x006C) | XCVR_RX_DIG_ACQ_FILT_10_11_DRS_H11(0x0090),
#else
...
#if RF_OSC_26MHZ == 1
    .acq_filt_4_7 = XCVR_RX_DIG_ACQ_FILT_4_7_H4(0x0006) | XCVR_RX_DIG_ACQ_FILT_4_7_H5(0xFFF7) |
                    XCVR_RX_DIG_ACQ_FILT_4_7_H6(0xFFE7) | XCVR_RX_DIG_ACQ_FILT_4_7_H7(0xFFE4),
#else
    .acq_filt_4_7       = XCVR_RX_DIG_ACQ_FILT_4_7_H4(0xFFF9) | XCVR_RX_DIG_ACQ_FILT_4_7_H5(0x0012) |
                    XCVR_RX_DIG_ACQ_FILT_4_7_H6(0x001C) | XCVR_RX_DIG_ACQ_FILT_4_7_H7(0xFFF7),
#endif /* RF_OSC_26MHZ == 1 */

/* ACQ_FILT_4_7_DRS configuration, dependencies: ['MD+DR', 'MD+DR', 'MD+DR', 'MD+DR'] */
#if RF_OSC_26MHZ == 1
    .acq_filt_4_7_drs = XCVR_RX_DIG_ACQ_FILT_4_7_DRS_H4(0xFFFE) | XCVR_RX_DIG_ACQ_FILT_4_7_DRS_H5(0xFFEE) |
                        XCVR_RX_DIG_ACQ_FILT_4_7_DRS_H6(0xFFE1) | XCVR_RX_DIG_ACQ_FILT_4_7_DRS_H7(0xFFE5),
#else
...
#if RF_OSC_26MHZ == 1
    .acq_filt_8_9 = XCVR_RX_DIG_ACQ_FILT_8_9_H8(0xFFFC) | XCVR_RX_DIG_ACQ_FILT_8_9_H9(0x002E),
#else
    .acq_filt_8_9     = XCVR_RX_DIG_ACQ_FILT_8_9_H8(0xFFC6) | XCVR_RX_DIG_ACQ_FILT_8_9_H9(0xFFE1),
#endif /* RF_OSC_26MHZ == 1 */

/* ACQ_FILT_8_9_DRS configuration, dependencies: ['MD+DR', 'MD+DR'] */
#if RF_OSC_26MHZ == 1
    .acq_filt_8_9_drs = XCVR_RX_DIG_ACQ_FILT_8_9_DRS_H8(0x0002) | XCVR_RX_DIG_ACQ_FILT_8_9_DRS_H9(0x0035),
#else
...
#if RF_OSC_26MHZ == 1
    .demod_filt_0_1 = XCVR_RX_DIG_DEMOD_FILT_0_1_H0(0xFFFD) | XCVR_RX_DIG_DEMOD_FILT_0_1_H1(0xFFFD),
#else
    .demod_filt_0_1 = XCVR_RX_DIG_DEMOD_FILT_0_1_H0(0xFFFD) | XCVR_RX_DIG_DEMOD_FILT_0_1_H1(0xFFFD),
#endif /* RF_OSC_26MHZ == 1 */
...
/* DEMOD_FILT_2_4 configuration, dependencies: ['MD+DR', 'MD+DR', 'MD+DR'] */
#if RF_OSC_26MHZ == 1
    .demod_filt_2_4 = XCVR_RX_DIG_DEMOD_FILT_2_4_H2(0x0021) | XCVR_RX_DIG_DEMOD_FILT_2_4_H3(0x0084) |
                      XCVR_RX_DIG_DEMOD_FILT_2_4_H4(0x00C0),
#else
    .demod_filt_2_4 = XCVR_RX_DIG_DEMOD_FILT_2_4_H2(0x0021) | XCVR_RX_DIG_DEMOD_FILT_2_4_H3(0x0084) |
                      XCVR_RX_DIG_DEMOD_FILT_2_4_H4(0x00C0),
#endif /* RF_OSC_26MHZ == 1 */
    ...
    .demod_filt_2_4_drs = XCVR_RX_DIG_DEMOD_FILT_2_4_DRS_H2(0x001D) | XCVR_RX_DIG_DEMOD_FILT_2_4_DRS_H3(0x0086) |
                          XCVR_RX_DIG_DEMOD_FILT_2_4_DRS_H4(0x00C8),
...
#if RF_OSC_26MHZ == 1
    .gfsk_coeff_0_1 = XCVR_TX_DIG_GFSK_COEFF_0_1_GFSK_COEFF_0(0x003) | XCVR_TX_DIG_GFSK_COEFF_0_1_GFSK_COEFF_1(0x00A),
#else
...
#if RF_OSC_26MHZ == 1
    .gfsk_coeff_2_3 = XCVR_TX_DIG_GFSK_COEFF_2_3_GFSK_COEFF_2(0x01B) | XCVR_TX_DIG_GFSK_COEFF_2_3_GFSK_COEFF_3(0x03E),
#else
    .gfsk_coeff_2_3 = XCVR_TX_DIG_GFSK_COEFF_2_3_GFSK_COEFF_2(0x001) | XCVR_TX_DIG_GFSK_COEFF_2_3_GFSK_COEFF_3(0x007),
#endif /* RF_OSC_26MHZ == 1 */

/* GFSK_COEFF_4_5 configuration, dependencies: ['MD+DR', 'MD+DR'] */
#if RF_OSC_26MHZ == 1
    .gfsk_coeff_4_5 = XCVR_TX_DIG_GFSK_COEFF_4_5_GFSK_COEFF_4(0x079) | XCVR_TX_DIG_GFSK_COEFF_4_5_GFSK_COEFF_5(0x0C6),
#else
    .gfsk_coeff_4_5 = XCVR_TX_DIG_GFSK_COEFF_4_5_GFSK_COEFF_4(0x025) | XCVR_TX_DIG_GFSK_COEFF_4_5_GFSK_COEFF_5(0x08A),
#endif /* RF_OSC_26MHZ == 1 */

/* GFSK_COEFF_6_7 configuration, dependencies: ['MD+DR', 'MD+DR'] */
#if RF_OSC_26MHZ == 1
    .gfsk_coeff_6_7 = XCVR_TX_DIG_GFSK_COEFF_6_7_GFSK_COEFF_6(0x114) | XCVR_TX_DIG_GFSK_COEFF_6_7_GFSK_COEFF_7(0x145),
#else
    .gfsk_coeff_6_7 = XCVR_TX_DIG_GFSK_COEFF_6_7_GFSK_COEFF_6(0x14A) | XCVR_TX_DIG_GFSK_COEFF_6_7_GFSK_COEFF_7(0x1FE),
#endif /* RF_OSC_26MHZ == 1 */
...
const xcvr_mode_datarate_config_t xcvr_gfsk_bt_0p7_h_0p5_500kbps_config = {
    ...
    /* FSK_CFG3 configuration, dependencies: ['MD+DR', 'MD+DR'] */
    .fsk_cfg3 = GEN4PHY_FSK_CFG3_MAG_THRESH_2M(0x0028) | GEN4PHY_FSK_CFG3_MAG_THRESH_HI_2M(0x005C),
...
/* ACQ_FILT_10_11_DRS configuration, dependencies: ['MD+DR', 'MD+DR'] */
#if RF_OSC_26MHZ == 1
    .acq_filt_10_11_drs = XCVR_RX_DIG_ACQ_FILT_10_11_DRS_H10(0x0066) | XCVR_RX_DIG_ACQ_FILT_10_11_DRS_H11(0x00AD),
#else
...
/* ACQ_FILT_4_7_DRS configuration, dependencies: ['MD+DR', 'MD+DR', 'MD+DR', 'MD+DR'] */
#if RF_OSC_26MHZ == 1
    .acq_filt_4_7_drs = XCVR_RX_DIG_ACQ_FILT_4_7_DRS_H4(0x0004) | XCVR_RX_DIG_ACQ_FILT_4_7_DRS_H5(0x0007) |
                        XCVR_RX_DIG_ACQ_FILT_4_7_DRS_H6(0xFFFD) | XCVR_RX_DIG_ACQ_FILT_4_7_DRS_H7(0xFFE8),
#else
...
/* ACQ_FILT_8_9_DRS configuration, dependencies: ['MD+DR', 'MD+DR'] */
#if RF_OSC_26MHZ == 1
    .acq_filt_8_9_drs = XCVR_RX_DIG_ACQ_FILT_8_9_DRS_H8(0xFFE4) | XCVR_RX_DIG_ACQ_FILT_8_9_DRS_H9(0x0011),
#else
...
/*! @brief GFSK BT=0.7, h=0.5 complete 1Mbps with 2Mbps alternate rate configuration. */
const xcvr_config_t xcvr_gfsk_bt_0p7_h_0p5_1mbps_full_config = {
    .common_cfg         = &xcvr_common_config,
    .mode_data_rate_cfg = &xcvr_gfsk_bt_0p7_h_0p5_1mbps_config,
};

/*! @brief GFSK BT=0.7, h=0.5 complete 1Mbps with 500Kbps alternate rate configuration. */
const xcvr_config_t xcvr_gfsk_bt_0p7_h_0p5_500kbps_full_config = {
    .common_cfg         = &xcvr_common_config,
    .mode_data_rate_cfg = &xcvr_gfsk_bt_0p7_h_0p5_500kbps_config,
};

/*! @brief GFSK BT=0.7, h=0.5 complete 1Mbps with 250Kbps alternate rate configuration. */
const xcvr_config_t xcvr_gfsk_bt_0p7_h_0p5_250kbps_full_config = {
    .common_cfg         = &xcvr_common_config,
    .mode_data_rate_cfg = &xcvr_gfsk_bt_0p7_h_0p5_250kbps_config,
};
