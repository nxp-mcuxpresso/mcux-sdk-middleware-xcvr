...
const xcvr_mode_datarate_config_t xcvr_oqpsk_802p15p4_250kbps_config = {
    ...
    .ll_ctrl = RADIO_CTRL_LL_CTRL_ACTIVE_LL(1),
    ...
    /* XCVR_CTRL configuration, dependencies: ['COM', 'MD+DR', 'MD+DR', 'COM', 'COM', 'MD+DR', 'COM', 'COM', 'COM',
       'COM', 'COM', 'COM'] */
    .xcvr_ctrl = XCVR_MISC_XCVR_CTRL_DATA_RATE_DRS(0) | XCVR_MISC_XCVR_CTRL_DEMOD_SEL(2) |
                 XCVR_MISC_XCVR_CTRL_LL_CFG_CAPT_DIS(1),

    /* XCVR_PLL_DIG configs */
    /************************/

    /* CHAN_MAP configuration, dependencies: ['MD', 'COM', 'COM', 'COM', 'COM'] */
    .chan_map = XCVR_PLL_DIG_CHAN_MAP_BAND_SELECT(4),
...
/* DATA_RATE_OVRD_CTRL2 configuration, dependencies: ['MD+DR'] */
    ...
    .delay_match = XCVR_PLL_DIG_DELAY_MATCH_HPM_INTEGER_DELAY(0x05) |
#if RF_OSC_26MHZ == 1
    ...
    .hpmcal_ctrl = XCVR_PLL_DIG_HPMCAL_CTRL_HPM_CAL_ARRAY_SIZE(1),

    /* HPM_BUMP configuration, dependencies: ['COM', 'COM', 'MD+DR', 'MD+DR', 'COM', 'COM'] */
    .hpm_bump = XCVR_PLL_DIG_HPM_BUMP_HPM_VCM_CAL(4) | XCVR_PLL_DIG_HPM_BUMP_HPM_VCM_TX(4),
...
#if RF_OSC_26MHZ == 1
    .acq_filt_0_3_drs = XCVR_RX_DIG_ACQ_FILT_0_3_DRS_H0(0x01) | XCVR_RX_DIG_ACQ_FILT_0_3_DRS_H1(0x3A) |
                        XCVR_RX_DIG_ACQ_FILT_0_3_DRS_H2(0x7F) | XCVR_RX_DIG_ACQ_FILT_0_3_DRS_H3(0x0F),
#else
    .acq_filt_0_3_drs = XCVR_RX_DIG_ACQ_FILT_0_3_DRS_H0(0x01) | XCVR_RX_DIG_ACQ_FILT_0_3_DRS_H1(0x3A) |
                        XCVR_RX_DIG_ACQ_FILT_0_3_DRS_H2(0x7F) | XCVR_RX_DIG_ACQ_FILT_0_3_DRS_H3(0x0F),
#endif /* RF_OSC_26MHZ == 1 */
...
#if RF_OSC_26MHZ == 1
    .acq_filt_10_11_drs = XCVR_RX_DIG_ACQ_FILT_10_11_DRS_H10(0x021) | XCVR_RX_DIG_ACQ_FILT_10_11_DRS_H11(0x12B),
#else
    .acq_filt_10_11_drs = XCVR_RX_DIG_ACQ_FILT_10_11_DRS_H10(0x021) | XCVR_RX_DIG_ACQ_FILT_10_11_DRS_H11(0x12B),
#endif /* RF_OSC_26MHZ == 1 */
...
#if RF_OSC_26MHZ == 1
    .acq_filt_4_7_drs = XCVR_RX_DIG_ACQ_FILT_4_7_DRS_H4(0x7F) | XCVR_RX_DIG_ACQ_FILT_4_7_DRS_H5(0x61) |
                        XCVR_RX_DIG_ACQ_FILT_4_7_DRS_H6(0x06) | XCVR_RX_DIG_ACQ_FILT_4_7_DRS_H7(0x3C),
#else
    .acq_filt_4_7_drs = XCVR_RX_DIG_ACQ_FILT_4_7_DRS_H4(0x7F) | XCVR_RX_DIG_ACQ_FILT_4_7_DRS_H5(0x61) |
                        XCVR_RX_DIG_ACQ_FILT_4_7_DRS_H6(0x06) | XCVR_RX_DIG_ACQ_FILT_4_7_DRS_H7(0x3C),
#endif /* RF_OSC_26MHZ == 1 */
...
#if RF_OSC_26MHZ == 1
    .acq_filt_8_9_drs = XCVR_RX_DIG_ACQ_FILT_8_9_DRS_H8(0x1F3) | XCVR_RX_DIG_ACQ_FILT_8_9_DRS_H9(0x194),
#else
    .acq_filt_8_9_drs = XCVR_RX_DIG_ACQ_FILT_8_9_DRS_H8(0x1F3) | XCVR_RX_DIG_ACQ_FILT_8_9_DRS_H9(0x194),
#endif /* RF_OSC_26MHZ == 1 */
...
#endif /* RF_OSC_26MHZ == 1 */
             XCVR_RX_DIG_CTRL0_RX_ACQ_FILT_LEN(0) | XCVR_RX_DIG_CTRL0_RX_FSK_ZB_SEL(1),
...
/* DEMOD_FILT_0_1 configuration, dependencies: ['MD+DR', 'MD+DR'] */
    ...
    .demod_filt_0_1_drs = XCVR_RX_DIG_DEMOD_FILT_0_1_DRS_H0(0x003) | XCVR_RX_DIG_DEMOD_FILT_0_1_DRS_H1(0x0FF),
...
/* DEMOD_FILT_2_4 configuration, dependencies: ['MD+DR', 'MD+DR', 'MD+DR'] */
    ...
    .demod_filt_2_4_drs = XCVR_RX_DIG_DEMOD_FILT_2_4_DRS_H2(0x1FF) | XCVR_RX_DIG_DEMOD_FILT_2_4_DRS_H3(0x088) |
    ...
    .rssi_global_ctrl = XCVR_RX_DIG_RSSI_GLOBAL_CTRL_NB_CCA1_ED_EN(1),
...
/* DATARATE_CONFIG_GFSK_CTRL configuration, dependencies: ['MD+DR'] */
    ...
    .data_padding_ctrl = XCVR_TX_DIG_DATA_PADDING_CTRL_DATA_PADDING_SEL(2) | XCVR_TX_DIG_DATA_PADDING_CTRL_PAD_DLY(0) |
                         XCVR_TX_DIG_DATA_PADDING_CTRL_PAD_DLY_EN(1),

    /* DATA_PADDING_CTRL_1 configuration, dependencies: ['COM', 'MD+DR', 'MD+DR'] */
    .data_padding_ctrl_1 =
        XCVR_TX_DIG_DATA_PADDING_CTRL_1_RAMP_UP_DLY(0x00) | XCVR_TX_DIG_DATA_PADDING_CTRL_1_TX_DATA_FLUSH_DLY(0x06),
...
/* GFSK_COEFF_6_7 configuration, dependencies: ['MD+DR', 'MD+DR'] */
    ...
    .pa_ctrl = XCVR_TX_DIG_PA_CTRL_PA_RAMP_SEL(2),

    /* TXDIG_CTRL configuration, dependencies: ['MD+DR', 'COM', 'MD+DR', 'MD+DR'] */
    .txdig_ctrl = XCVR_TX_DIG_TXDIG_CTRL_DATA_STREAM_SEL(1) | XCVR_TX_DIG_TXDIG_CTRL_MODULATOR_SEL(1) |
