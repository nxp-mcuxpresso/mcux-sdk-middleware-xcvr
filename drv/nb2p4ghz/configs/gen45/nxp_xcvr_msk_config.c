...
const xcvr_mode_datarate_config_t xcvr_msk_1mbps_config = {
    ...
    .fsk_cfg0 = GEN4PHY_FSK_CFG0_AA_ACQ_1_2_3_THRESH_1M(0x1A) | GEN4PHY_FSK_CFG0_AA_ACQ_1_2_3_THRESH_2M(0x1C) |
                GEN4PHY_FSK_CFG0_MSK2FSK_SEED(1) | GEN4PHY_FSK_CFG0_MSK_EN(1),
    ...
    .fsk_pd_cfg2 = GEN4PHY_FSK_PD_CFG2_PD_THRESH_ACQ_1_3_1M(0xE6) | GEN4PHY_FSK_PD_CFG2_PD_THRESH_ACQ_1_3_2M(0xF6),
...
#if RF_OSC_26MHZ == 1
    .data_padding_ctrl_2 =
        XCVR_TX_DIG_DATA_PADDING_CTRL_2_DATA_PAD_MFDEV(0x1B0D) | XCVR_TX_DIG_DATA_PADDING_CTRL_2_DATA_PAD_PFDEV(0x04F2),
#else
    .data_padding_ctrl_2 =
        XCVR_TX_DIG_DATA_PADDING_CTRL_2_DATA_PAD_MFDEV(0x1BF9) | XCVR_TX_DIG_DATA_PADDING_CTRL_2_DATA_PAD_PFDEV(0x0406),
#endif /* RF_OSC_26MHZ == 1 */
