...
#if RF_OSC_26MHZ == 1
    .acq_filt_0_3 = XCVR_RX_DIG_ACQ_FILT_0_3_H0(0x3B) | XCVR_RX_DIG_ACQ_FILT_0_3_H1(0x01) |
                    XCVR_RX_DIG_ACQ_FILT_0_3_H2(0x0C) | XCVR_RX_DIG_ACQ_FILT_0_3_H3(0x13),
#else
    .acq_filt_0_3 = XCVR_RX_DIG_ACQ_FILT_0_3_H0(0x01) | XCVR_RX_DIG_ACQ_FILT_0_3_H1(0x05) |
                    XCVR_RX_DIG_ACQ_FILT_0_3_H2(0x02) | XCVR_RX_DIG_ACQ_FILT_0_3_H3(0x74),
#endif /* RF_OSC_26MHZ == 1 */

/* ACQ_FILT_0_3_DRS configuration, dependencies: ['MD+DR', 'MD+DR', 'MD+DR', 'MD+DR'] */
#if RF_OSC_26MHZ == 1
    .acq_filt_0_3_drs = XCVR_RX_DIG_ACQ_FILT_0_3_DRS_H0(0x03) | XCVR_RX_DIG_ACQ_FILT_0_3_DRS_H1(0x0A) |
                        XCVR_RX_DIG_ACQ_FILT_0_3_DRS_H2(0x0C) | XCVR_RX_DIG_ACQ_FILT_0_3_DRS_H3(0x07),
#else
...
#if RF_OSC_26MHZ == 1
    .acq_filt_10_11 = XCVR_RX_DIG_ACQ_FILT_10_11_H10(0x06F) | XCVR_RX_DIG_ACQ_FILT_10_11_H11(0x09C),
#else
    .acq_filt_10_11     = XCVR_RX_DIG_ACQ_FILT_10_11_H10(0x05B) | XCVR_RX_DIG_ACQ_FILT_10_11_H11(0x0FB),
#endif /* RF_OSC_26MHZ == 1 */

/* ACQ_FILT_10_11_DRS configuration, dependencies: ['MD+DR', 'MD+DR'] */
#if RF_OSC_26MHZ == 1
    .acq_filt_10_11_drs = XCVR_RX_DIG_ACQ_FILT_10_11_DRS_H10(0x069) | XCVR_RX_DIG_ACQ_FILT_10_11_DRS_H11(0x088),
#else
...
#if RF_OSC_26MHZ == 1
    .acq_filt_4_7 = XCVR_RX_DIG_ACQ_FILT_4_7_H4(0x0C) | XCVR_RX_DIG_ACQ_FILT_4_7_H5(0x77) |
                    XCVR_RX_DIG_ACQ_FILT_4_7_H6(0xDF) | XCVR_RX_DIG_ACQ_FILT_4_7_H7(0xD8),
#else
    .acq_filt_4_7       = XCVR_RX_DIG_ACQ_FILT_4_7_H4(0x71) | XCVR_RX_DIG_ACQ_FILT_4_7_H5(0x0F) |
                    XCVR_RX_DIG_ACQ_FILT_4_7_H6(0x28) | XCVR_RX_DIG_ACQ_FILT_4_7_H7(0x03),
#endif /* RF_OSC_26MHZ == 1 */

/* ACQ_FILT_4_7_DRS configuration, dependencies: ['MD+DR', 'MD+DR', 'MD+DR', 'MD+DR'] */
#if RF_OSC_26MHZ == 1
    .acq_filt_4_7_drs = XCVR_RX_DIG_ACQ_FILT_4_7_DRS_H4(0x7A) | XCVR_RX_DIG_ACQ_FILT_4_7_DRS_H5(0x69) |
                        XCVR_RX_DIG_ACQ_FILT_4_7_DRS_H6(0xE0) | XCVR_RX_DIG_ACQ_FILT_4_7_DRS_H7(0xE9),
#else
...
#if RF_OSC_26MHZ == 1
    .acq_filt_8_9 = XCVR_RX_DIG_ACQ_FILT_8_9_H8(0x1F2) | XCVR_RX_DIG_ACQ_FILT_8_9_H9(0x02B),
#else
    .acq_filt_8_9     = XCVR_RX_DIG_ACQ_FILT_8_9_H8(0x1BB) | XCVR_RX_DIG_ACQ_FILT_8_9_H9(0x1C7),
#endif /* RF_OSC_26MHZ == 1 */

/* ACQ_FILT_8_9_DRS configuration, dependencies: ['MD+DR', 'MD+DR'] */
#if RF_OSC_26MHZ == 1
    .acq_filt_8_9_drs = XCVR_RX_DIG_ACQ_FILT_8_9_DRS_H8(0x008) | XCVR_RX_DIG_ACQ_FILT_8_9_DRS_H9(0x039),
#else
...
#if RF_OSC_26MHZ == 1
    .demod_filt_0_1 = XCVR_RX_DIG_DEMOD_FILT_0_1_H0(0x1FD) | XCVR_RX_DIG_DEMOD_FILT_0_1_H1(0x1FA),
#else
    .demod_filt_0_1 = XCVR_RX_DIG_DEMOD_FILT_0_1_H0(0x1FD) | XCVR_RX_DIG_DEMOD_FILT_0_1_H1(0x1FA),
#endif /* RF_OSC_26MHZ == 1 */

    /* DEMOD_FILT_0_1_DRS configuration, dependencies: ['MD+DR', 'MD+DR'] */
    .demod_filt_0_1_drs = XCVR_RX_DIG_DEMOD_FILT_0_1_DRS_H0(0x1FD) | XCVR_RX_DIG_DEMOD_FILT_0_1_DRS_H1(0x1FA),

/* DEMOD_FILT_2_4 configuration, dependencies: ['MD+DR', 'MD+DR', 'MD+DR'] */
#if RF_OSC_26MHZ == 1
    .demod_filt_2_4 = XCVR_RX_DIG_DEMOD_FILT_2_4_H2(0x01C) | XCVR_RX_DIG_DEMOD_FILT_2_4_H3(0x086) |
                      XCVR_RX_DIG_DEMOD_FILT_2_4_H4(0x0CA),
#else
    .demod_filt_2_4 = XCVR_RX_DIG_DEMOD_FILT_2_4_H2(0x01C) | XCVR_RX_DIG_DEMOD_FILT_2_4_H3(0x086) |
                      XCVR_RX_DIG_DEMOD_FILT_2_4_H4(0x0CA),
#endif /* RF_OSC_26MHZ == 1 */
    ...
    .demod_filt_2_4_drs = XCVR_RX_DIG_DEMOD_FILT_2_4_DRS_H2(0x01A) | XCVR_RX_DIG_DEMOD_FILT_2_4_DRS_H3(0x087) |
                          XCVR_RX_DIG_DEMOD_FILT_2_4_DRS_H4(0x0CE),
...
#if RF_OSC_26MHZ == 1
    .gfsk_coeff_4_5 = XCVR_TX_DIG_GFSK_COEFF_4_5_GFSK_COEFF_4(0x000) | XCVR_TX_DIG_GFSK_COEFF_4_5_GFSK_COEFF_5(0x007),
#else
...
#if RF_OSC_26MHZ == 1
    .gfsk_coeff_6_7 = XCVR_TX_DIG_GFSK_COEFF_6_7_GFSK_COEFF_6(0x068) | XCVR_TX_DIG_GFSK_COEFF_6_7_GFSK_COEFF_7(0x191),
#else
    .gfsk_coeff_6_7 = XCVR_TX_DIG_GFSK_COEFF_6_7_GFSK_COEFF_6(0x00E) | XCVR_TX_DIG_GFSK_COEFF_6_7_GFSK_COEFF_7(0x1F1),
#endif /* RF_OSC_26MHZ == 1 */
