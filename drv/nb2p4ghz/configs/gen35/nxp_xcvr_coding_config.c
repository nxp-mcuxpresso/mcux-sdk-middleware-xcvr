...
const xcvr_coding_config_t xcvr_ble_coded_s2_config = {
    ...
    .fec_cfg1 = RBME_FEC_CFG1_FECOV_EN(1) | RBME_FEC_CFG1_FEC_EN(0) | RBME_FEC_CFG1_FEC_SWAP(0) |
                RBME_FEC_CFG1_INTV_EN(0) | RBME_FEC_CFG1_NTERM(3),

    /* FEC_CFG2 configuration, dependencies: [None, None, None, None] */
    .fec_cfg2 = RBME_FEC_CFG2_LARGE_VL(0x7F) | RBME_FEC_CFG2_SAT_VL(0x7F) | RBME_FEC_CFG2_SDIDX(0) |
    ...
    .ram_if_cfg = RBME_RAM_IF_CFG_H2S_EN(0) | RBME_RAM_IF_CFG_RAM_IF_IC(0) | RBME_RAM_IF_CFG_RAM_IF_IE(0) |
                  RBME_RAM_IF_CFG_RAM_IF_RX_EN(0) | RBME_RAM_IF_CFG_RAM_IF_TX_EN(0) |
                  RBME_RAM_IF_CFG_SOFT_HD_SEL_RD(0) | RBME_RAM_IF_CFG_SOFT_HD_SEL_WR(0),
    ...
    .spread_cfg = RBME_SPREAD_CFG_CI_TX(1) | RBME_SPREAD_CFG_SPOV_EN(0) | RBME_SPREAD_CFG_SP_EN(0) |
                  RBME_SPREAD_CFG_SP_FACTOR(0x02) | RBME_SPREAD_CFG_SP_SEQ(0x000C),
    ...
    .wht_cfg = RBME_WHT_CFG_W1_EN(0) | RBME_WHT_CFG_WFIRST(0) | RBME_WHT_CFG_WTOV_EN(0) | RBME_WHT_CFG_WT_OUT_SEL(0) |
    ...
    .dmd_ctrl1 = XCVR_2P4GHZ_PHY_DMD_CTRL1_FED_IDLE_WIN(0x0008) | XCVR_2P4GHZ_PHY_DMD_CTRL1_FED_IMM_MEAS_EN(1) |
                 XCVR_2P4GHZ_PHY_DMD_CTRL1_TED_ERR_SCALE(0x04) | XCVR_2P4GHZ_PHY_DMD_CTRL1_TED_IDLE_WIN(0x0004) |
                 XCVR_2P4GHZ_PHY_DMD_CTRL1_TED_IMM_MEAS_EN(1) | XCVR_2P4GHZ_PHY_DMD_CTRL1_TTRK_INT_RANGE(0x03),
    /***********************************************/
...
const xcvr_coding_config_t xcvr_ble_uncoded_config = {
    ...
    /* FEC_CFG1 configuration, dependencies: [None, None, None, None, None] */
    .fec_cfg1 = RBME_FEC_CFG1_FECOV_EN(0) | RBME_FEC_CFG1_FEC_EN(0) | RBME_FEC_CFG1_FEC_SWAP(0) |
                RBME_FEC_CFG1_INTV_EN(0) | RBME_FEC_CFG1_NTERM(0),
    ...
    .spread_cfg = RBME_SPREAD_CFG_CI_TX(0) | RBME_SPREAD_CFG_SPOV_EN(0) | RBME_SPREAD_CFG_SP_EN(0) |
                  RBME_SPREAD_CFG_SP_FACTOR(0x00) | RBME_SPREAD_CFG_SP_SEQ(0x0000),
