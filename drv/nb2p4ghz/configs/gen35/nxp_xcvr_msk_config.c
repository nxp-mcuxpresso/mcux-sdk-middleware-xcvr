...
const xcvr_mode_datarate_config_t xcvr_msk_1mbps_config = {
    ...
    .demod_wave[1].dmd_wave_reg1 =
        XCVR_2P4GHZ_PHY_DMD_WAVE_REG1_SMPL5(0x0C) | XCVR_2P4GHZ_PHY_DMD_WAVE_REG1_SMPL6(0x3C) |
        XCVR_2P4GHZ_PHY_DMD_WAVE_REG1_SMPL7(0x38) | XCVR_2P4GHZ_PHY_DMD_WAVE_REG1_SMPL8(0x34) |
    ...
    .fsk_cfg0 = XCVR_2P4GHZ_PHY_FSK_CFG0_AA_ACQ_1_2_3_THRESH_1M(0x17) | XCVR_2P4GHZ_PHY_FSK_CFG0_MSK2FSK_SEED(1) |
#if RF_OSC_26MHZ == 1
    ...
    .fsk_cfg2 = XCVR_2P4GHZ_PHY_FSK_CFG2_MAG_THRESH_1M(0x00D0) | XCVR_2P4GHZ_PHY_FSK_CFG2_MAG_THRESH_HI_1M(0x01D0),

    /* FSK_CFG3 configuration, dependencies: ['MD+DR', 'MD+DR'] */
    .fsk_cfg3 = XCVR_2P4GHZ_PHY_FSK_CFG3_MAG_THRESH_2M(0x0118) | XCVR_2P4GHZ_PHY_FSK_CFG3_MAG_THRESH_HI_2M(0x0280),
    ...
    /* RX_BBA configuration, dependencies: ['MD+DR', 'MD+DR', 'COM', 'MD+DR', 'MD+DR', 'COM', 'COM', 'COM', 'COM',
       'COM', 'COM'] */
    .rx_bba = XCVR_ANALOG_RX_BBA_RX_BBA2_BW_SEL(0) | XCVR_ANALOG_RX_BBA_RX_BBA2_BW_SEL_DRS(0) |
              XCVR_ANALOG_RX_BBA_RX_BBA_BW_SEL(0) | XCVR_ANALOG_RX_BBA_RX_BBA_BW_SEL_DRS(0),
 ...
 * 'COM', 'COM'] */
    ...
    .dcoc_ctrl_1 =
        XCVR_RX_DIG_DCOC_CTRL_1_DCOC_ALPHA_RADIUS_ALT_IDX(5) | XCVR_RX_DIG_DCOC_CTRL_1_DCOC_ALPHA_RADIUS_IDX(5),
...
/* GFSK_CTRL configuration, dependencies: ['COM', 'COM', 'MD+DR'] */
    ...
    .image_filter_ctrl =
        XCVR_TX_DIG_IMAGE_FILTER_CTRL_IMAGE_FILTER_OVRD_EN(1) | XCVR_TX_DIG_IMAGE_FILTER_CTRL_IMAGE_FIR_FILTER_SEL(0),
...
const xcvr_mode_datarate_config_t xcvr_msk_500kbps_config = {
    ...
    /* FSK_CFG3 configuration, dependencies: ['MD+DR', 'MD+DR'] */
    .fsk_cfg3 = XCVR_2P4GHZ_PHY_FSK_CFG3_MAG_THRESH_2M(0x0098) | XCVR_2P4GHZ_PHY_FSK_CFG3_MAG_THRESH_HI_2M(0x0160),
    ...
    /* RX_BBA configuration, dependencies: ['MD+DR', 'MD+DR', 'COM', 'MD+DR', 'MD+DR', 'COM', 'COM', 'COM', 'COM',
       'COM', 'COM'] */
    .rx_bba = XCVR_ANALOG_RX_BBA_RX_BBA2_BW_SEL(0) | XCVR_ANALOG_RX_BBA_RX_BBA2_BW_SEL_DRS(4) |
              XCVR_ANALOG_RX_BBA_RX_BBA_BW_SEL(0) | XCVR_ANALOG_RX_BBA_RX_BBA_BW_SEL_DRS(4),
...
/* RX_DIG_CTRL_DRS configuration, dependencies: ['MD+DR'] */
    ...
    /* RX_RCCAL_CTRL0 configuration, dependencies: ['MD+DR', 'MD+DR', 'MD+DR', 'MD+DR', 'MD+DR', 'MD+DR', 'MD+DR',
       'MD+DR'] */
    .rx_rccal_ctrl0 = XCVR_RX_DIG_RX_RCCAL_CTRL0_BBA_RCCAL_DIS(0) | XCVR_RX_DIG_RX_RCCAL_CTRL0_BBA_RCCAL_MANUAL(0x1F) |
                      XCVR_RX_DIG_RX_RCCAL_CTRL0_BBA_RCCAL_OFFSET(0x00) | XCVR_RX_DIG_RX_RCCAL_CTRL0_RCCAL_COMP_INV(0) |
                      XCVR_RX_DIG_RX_RCCAL_CTRL0_RCCAL_SMP_DLY(0) | XCVR_RX_DIG_RX_RCCAL_CTRL0_TZA_RCCAL_DIS(0) |
...
const xcvr_mode_datarate_config_t xcvr_msk_250kbps_config = {
    ...
    /* FSK_CFG3 configuration, dependencies: ['MD+DR', 'MD+DR'] */
    .fsk_cfg3 = XCVR_2P4GHZ_PHY_FSK_CFG3_MAG_THRESH_2M(0x0070) | XCVR_2P4GHZ_PHY_FSK_CFG3_MAG_THRESH_HI_2M(0x0100),
    ...
    /* FSK_PD_CFG2 configuration, dependencies: ['MD+DR', 'MD+DR'] */
    .fsk_pd_cfg2 =
        XCVR_2P4GHZ_PHY_FSK_PD_CFG2_PD_THRESH_ACQ_1_3_1M(0xB8) | XCVR_2P4GHZ_PHY_FSK_PD_CFG2_PD_THRESH_ACQ_1_3_2M(0xB8),
    ...
    /* RX_BBA configuration, dependencies: ['MD+DR', 'MD+DR', 'COM', 'MD+DR', 'MD+DR', 'COM', 'COM', 'COM', 'COM',
       'COM', 'COM'] */
    .rx_bba = XCVR_ANALOG_RX_BBA_RX_BBA2_BW_SEL(0) | XCVR_ANALOG_RX_BBA_RX_BBA2_BW_SEL_DRS(5) |
              XCVR_ANALOG_RX_BBA_RX_BBA_BW_SEL(0) | XCVR_ANALOG_RX_BBA_RX_BBA_BW_SEL_DRS(5),
...
/* DCOC_CTRL_2 configuration, dependencies: ['DR', 'DR'] */
    ...
    /* DC_RESID_CTRL configuration, dependencies: ['COM', 'MD+DR', 'COM', 'COM', 'COM', 'MD+DR', 'DR', 'MD+DR', 'COM']
     */
    .dc_resid_ctrl = XCVR_RX_DIG_DC_RESID_CTRL_DC_RESID_DLY(4) | XCVR_RX_DIG_DC_RESID_CTRL_DC_RESID_ITER_FREEZE(0x07) |
                     XCVR_RX_DIG_DC_RESID_CTRL_DC_RESID_MIN_AGC_IDX(0x1A) |
                     XCVR_RX_DIG_DC_RESID_CTRL_DC_RESID_NWIN(0x3C),
