...
xcvrStatus_t XCVR_RadioGenRegSetup(const xcvr_config_t *xcvr_config)
{
    ...
    if (xcvr_config != NULLPTR)
    {
        ...
        XCVR_2P4GHZ_PHY->FSK_CFG0                    = mode_datarate_cfg->fsk_cfg0 | common_cfg->fsk_cfg0;
        XCVR_2P4GHZ_PHY->FSK_CFG1                    = mode_datarate_cfg->fsk_cfg1;
        XCVR_2P4GHZ_PHY->FSK_CFG2                    = mode_datarate_cfg->fsk_cfg2 | common_cfg->fsk_cfg2;
        ...
        XCVR_2P4GHZ_PHY->SM_CFG                      = mode_datarate_cfg->sm_cfg | common_cfg->sm_cfg;
        /***********************/
        /* XCVR_ANALOG configs */
        /***********************/
        ...
        XCVR_ANALOG->RX_BBA    = mode_datarate_cfg->rx_bba | common_cfg->rx_bba;
        XCVR_ANALOG->RX_LNA    = common_cfg->rx_lna;
        XCVR_ANALOG->RX_TZA    = common_cfg->rx_tza | mode_datarate_cfg->rx_tza;
        XCVR_ANALOG->SY_CTRL_1 = common_cfg->sy_ctrl_1;
        XCVR_ANALOG->SY_CTRL_2 = common_cfg->sy_ctrl_2 | mode_datarate_cfg->sy_ctrl_2;
        ...
        XCVR_PLL_DIG->DATA_RATE_OVRD_CTRL1 = mode_datarate_cfg->data_rate_ovrd_ctrl1 | common_cfg->data_rate_ovrd_ctrl1;
        ...
        /*************************/
        XCVR_PLL_DIG2->HPMCAL_CTRL = mode_datarate_cfg->hpmcal_ctrl | common_cfg->hpmcal_ctrl;
        /***********************/
        /* XCVR_RX_DIG configs */
        /***********************/
        XCVR_RX_DIG->AGC_CTRL_0                = common_cfg->agc_ctrl_0 | mode_datarate_cfg->agc_ctrl_0;
        XCVR_RX_DIG->AGC_CTRL_0_DRS            = mode_datarate_cfg->agc_ctrl_0_drs;
        XCVR_RX_DIG->AGC_CTRL_1                = common_cfg->agc_ctrl_1 | mode_datarate_cfg->agc_ctrl_1;
        XCVR_RX_DIG->AGC_CTRL_1_DRS            = mode_datarate_cfg->agc_ctrl_1_drs | common_cfg->agc_ctrl_1_drs;
        XCVR_RX_DIG->AGC_CTRL_2                = mode_datarate_cfg->agc_ctrl_2 | common_cfg->agc_ctrl_2;
        XCVR_RX_DIG->AGC_CTRL_2_DRS            = mode_datarate_cfg->agc_ctrl_2_drs | common_cfg->agc_ctrl_2_drs;
        XCVR_RX_DIG->AGC_CTRL_3                = common_cfg->agc_ctrl_3 | mode_datarate_cfg->agc_ctrl_3;
        XCVR_RX_DIG->AGC_CTRL_4                = common_cfg->agc_ctrl_4 | mode_datarate_cfg->agc_ctrl_4;
        ...
        XCVR_RX_DIG->DCOC_CTRL_0               = common_cfg->dcoc_ctrl_0 | mode_datarate_cfg->dcoc_ctrl_0;
        XCVR_RX_DIG->DCOC_CTRL_1               = common_cfg->dcoc_ctrl_1 | mode_datarate_cfg->dcoc_ctrl_1;
        ...
        XCVR_RX_DIG->DC_RESID_CTRL             = common_cfg->dc_resid_ctrl | mode_datarate_cfg->dc_resid_ctrl;
        ...
        XCVR_RX_DIG->RX_DIG_CTRL               = common_cfg->rx_dig_ctrl | mode_datarate_cfg->rx_dig_ctrl;
        ...
        XCVR_TX_DIG->GFSK_CTRL           = common_cfg->gfsk_ctrl | mode_datarate_cfg->gfsk_ctrl;
        ...
        XCVR_TX_DIG->TXDIG_CTRL          = common_cfg->txdig_ctrl | mode_datarate_cfg->txdig_ctrl;
        /* Return status */
...
#define A0_XCVR_2P4GHZ_PHY_DMD_CTRL0_TED_ACT_WIN(x)                                    \
    (((uint32_t)(((uint32_t)(x)) << A0_XCVR_2P4GHZ_PHY_DMD_CTRL0_TED_ACT_WIN_SHIFT)) & \
     A0_XCVR_2P4GHZ_PHY_DMD_CTRL0_TED_ACT_WIN_MASK)
#define A0_XCVR_2P4GHZ_PHY_DMD_CTRL0_FED_ACT_WIN_MASK (0x3F00U)
#define A0_XCVR_2P4GHZ_PHY_DMD_CTRL0_FED_ACT_WIN_SHIFT (8U)
#define A0_XCVR_2P4GHZ_PHY_DMD_CTRL0_FED_ACT_WIN(x)                                    \
    (((uint32_t)(((uint32_t)(x)) << A0_XCVR_2P4GHZ_PHY_DMD_CTRL0_FED_ACT_WIN_SHIFT)) & \
     A0_XCVR_2P4GHZ_PHY_DMD_CTRL0_FED_ACT_WIN_MASK)

        /* Configure XCVR_2P4GHZ_PHY_DMD_CTRL0_TED_ACT_WIN */
        XCVR_2P4GHZ_PHY->DMD_CTRL0 &=
            ~(A0_XCVR_2P4GHZ_PHY_DMD_CTRL0_TED_ACT_WIN_MASK | A0_XCVR_2P4GHZ_PHY_DMD_CTRL0_FED_ACT_WIN_MASK);
        XCVR_2P4GHZ_PHY->DMD_CTRL0 |=
            (A0_XCVR_2P4GHZ_PHY_DMD_CTRL0_TED_ACT_WIN(0x10U) | A0_XCVR_2P4GHZ_PHY_DMD_CTRL0_FED_ACT_WIN(0x10U));
        ...
        {
            /* Create a additive factor to add the tx_ofst_usec to the TSM timings on the fly. This factor applies only
             * to the A0 silicon */
            /* For A0 support, this replaces previous code which was only driven by a compile option. */
            uint32_t offset_adder =
                B1(tx_ofst_usec) | B0(tx_ofst_usec); /* Must apply offset to both TX_HI and TX_LO fields of TSM */
    ...
    else
    {
        if (XCVR_ReadRadioVer() == (uint16_t)XCVR_RADIO_GEN_3P5_B0)
        {
            ...
            XCVR_RX_DIG->DC_RESID_CTRL2 =
                (XCVR_RX_DIG_DC_RESID_CTRL2_DC_RESID_NWIN2(128U) | XCVR_RX_DIG_DC_RESID_CTRL2_DC_RESID_PHY_STOP_EN(1U) |
                 XCVR_RX_DIG_DC_RESID_CTRL2_DC_RESID_CC_EN(1U) | XCVR_RX_DIG_DC_RESID_CTRL2_DC_RESID_SR2_EN(0U) |
                 XCVR_RX_DIG_DC_RESID_CTRL2_DC_RESID_ALPHA2(3U) | XCVR_RX_DIG_DC_RESID_CTRL2_DC_RESID_GS2_EN(0U) |
