...
/***********************************************/
    ...
    /* FSK_CFG0 configuration, dependencies: ['MD+DR', 'MD+DR', 'COM', 'COM', 'COM', 'COM', 'COM', 'MD', 'MD'] */
    .fsk_cfg0 = GEN4PHY_FSK_CFG0_AA_OUT_SEL(1) | GEN4PHY_FSK_CFG0_BLE_NTW_ADR_THR(0) |
                GEN4PHY_FSK_CFG0_EN_HIRES_TOF(0) | GEN4PHY_FSK_CFG0_FSK_BIT_INVERT(0) |
                GEN4PHY_FSK_CFG0_HAMMING_AA_LOW_PWR(0),
    ...
    /* PLL configuration, dependencies: ['COM', 'COM', 'COM', 'COM', 'COM', 'COM'] */
    ...
    /* XCVR_CTRL configuration, dependencies: ['COM', 'MD+DR', 'COM', 'COM', 'COM', 'COM', 'COM', 'COM', 'COM', 'COM',
       'COM', 'COM'] */
    .xcvr_ctrl =
        XCVR_MISC_XCVR_CTRL_DATA_RATE(1) | XCVR_MISC_XCVR_CTRL_DEMOD_SEL(1) | XCVR_MISC_XCVR_CTRL_LPPS_ENABLE(0) |
#if defined(FFU_SMAC_REG_OFFSET_REQ)
        XCVR_MISC_XCVR_CTRL_FO_RX_EN(0) | XCVR_MISC_XCVR_CTRL_FO_TX_EN(1) | XCVR_MISC_XCVR_CTRL_LL_CFG_CAPT_DIS(0) |
        XCVR_MISC_XCVR_CTRL_SDCLK_OUT_EN(0) | XCVR_MISC_XCVR_CTRL_TOF_RX_SEL(0) | XCVR_MISC_XCVR_CTRL_TOF_TX_SEL(0) |
#endif // defined(FFU_SMAC_REG_OFFSET_REQ)
#if RF_OSC_26MHZ == 1
    ...
    /* CTUNE_CTRL configuration, dependencies: ['COM', 'COM', 'COM', 'COM', 'COM', 'COM'] */
    ...
    .hpmcal_ctrl = XCVR_PLL_DIG_HPMCAL_CTRL_HPM_CAL_ARRAY_SIZE(1) | XCVR_PLL_DIG_HPMCAL_CTRL_HPM_CAL_BUMPED(0) |
    ...
    /* HPM_BUMP configuration, dependencies: ['COM', 'COM', 'COM', 'COM', 'COM', 'COM'] */
    .hpm_bump = XCVR_PLL_DIG_HPM_BUMP_HPM_FDB_RES_CAL(0) | XCVR_PLL_DIG_HPM_BUMP_HPM_FDB_RES_TX(1) |
                XCVR_PLL_DIG_HPM_BUMP_HPM_VCM_CAL(2) | XCVR_PLL_DIG_HPM_BUMP_HPM_VCM_TX(0) |
    ...
    .pll_datarate_ctrl =
        XCVR_PLL_DIG_PLL_DATARATE_CTRL_HPM_INTEGER_DELAY_DRS(0x0) |
        XCVR_PLL_DIG_PLL_DATARATE_CTRL_HPM_SDM_DELAY_DRS(0x0) | XCVR_PLL_DIG_PLL_DATARATE_CTRL_HPM_VCM_CAL_DRS(1) |
        XCVR_PLL_DIG_PLL_DATARATE_CTRL_HPM_VCM_TX_DRS(2) | XCVR_PLL_DIG_PLL_DATARATE_CTRL_LPM_SDM_DELAY_DRS(0x0) |
    ...
    .tuning_cap_rx_ctrl =
        XCVR_PLL_DIG_TUNING_CAP_RX_CTRL_TUNING_RANGE_0(3) | XCVR_PLL_DIG_TUNING_CAP_RX_CTRL_TUNING_RANGE_1(3) |
        XCVR_PLL_DIG_TUNING_CAP_RX_CTRL_TUNING_RANGE_2(3) | XCVR_PLL_DIG_TUNING_CAP_RX_CTRL_TUNING_RANGE_3(3) |
        XCVR_PLL_DIG_TUNING_CAP_RX_CTRL_TUNING_RANGE_4(3) | XCVR_PLL_DIG_TUNING_CAP_RX_CTRL_TUNING_RANGE_5(3) |
        XCVR_PLL_DIG_TUNING_CAP_RX_CTRL_TUNING_RANGE_6(3) | XCVR_PLL_DIG_TUNING_CAP_RX_CTRL_TUNING_RANGE_7(3),

    /* TUNING_CAP_TX_CTRL configuration, dependencies: ['COM', 'COM', 'COM', 'COM', 'COM', 'COM', 'COM', 'COM'] */
    .tuning_cap_tx_ctrl =
        XCVR_PLL_DIG_TUNING_CAP_TX_CTRL_TUNING_RANGE_0(3) | XCVR_PLL_DIG_TUNING_CAP_TX_CTRL_TUNING_RANGE_1(3) |
        XCVR_PLL_DIG_TUNING_CAP_TX_CTRL_TUNING_RANGE_2(3) | XCVR_PLL_DIG_TUNING_CAP_TX_CTRL_TUNING_RANGE_3(3) |
        XCVR_PLL_DIG_TUNING_CAP_TX_CTRL_TUNING_RANGE_4(3) | XCVR_PLL_DIG_TUNING_CAP_TX_CTRL_TUNING_RANGE_5(3) |
        XCVR_PLL_DIG_TUNING_CAP_TX_CTRL_TUNING_RANGE_6(3) | XCVR_PLL_DIG_TUNING_CAP_TX_CTRL_TUNING_RANGE_7(3),
    ...
    .agc_idx0_gain_val = XCVR_RX_DIG_AGC_IDX0_GAIN_VAL_LOG_GAIN_0(0x3F1) |
                         XCVR_RX_DIG_AGC_IDX0_GAIN_VAL_MAG_THR_0(0x080) |
                         XCVR_RX_DIG_AGC_IDX0_GAIN_VAL_MAG_THR_HI_0(0x100),
    ...
    .agc_idx10_gain_val = XCVR_RX_DIG_AGC_IDX10_GAIN_VAL_LOG_GAIN_10(0x0EB) |
                          XCVR_RX_DIG_AGC_IDX10_GAIN_VAL_MAG_THR_10(0x080) |
                          XCVR_RX_DIG_AGC_IDX10_GAIN_VAL_MAG_THR_HI_10(0x100),
    ...
    /* AGC_IDX11_GAIN_CFG configuration, dependencies: ['COM', 'COM', 'COM', 'COM', 'COM', 'COM', 'COM', 'COM', 'COM']
     */
    .agc_idx11_gain_cfg =
        ...
        XCVR_RX_DIG_AGC_IDX11_GAIN_CFG_LNA_RTRIM_11(1) | XCVR_RX_DIG_AGC_IDX11_GAIN_CFG_MAG_THR_11_DRS_OFS(0x00) |
        XCVR_RX_DIG_AGC_IDX11_GAIN_CFG_MAG_THR_HI_11_DRS_OFS(0x00),

    /* AGC_IDX11_GAIN_VAL configuration, dependencies: ['COM', 'COM', 'COM'] */
    .agc_idx11_gain_val = XCVR_RX_DIG_AGC_IDX11_GAIN_VAL_LOG_GAIN_11(0x0FA) |
                          XCVR_RX_DIG_AGC_IDX11_GAIN_VAL_MAG_THR_11(0x080) |
                          XCVR_RX_DIG_AGC_IDX11_GAIN_VAL_MAG_THR_HI_11(0x100),
    ...
    .agc_idx1_gain_val = XCVR_RX_DIG_AGC_IDX1_GAIN_VAL_LOG_GAIN_1(0x00B) |
                         XCVR_RX_DIG_AGC_IDX1_GAIN_VAL_MAG_THR_1(0x080) |
                         XCVR_RX_DIG_AGC_IDX1_GAIN_VAL_MAG_THR_HI_1(0x100),
    ...
    .agc_idx2_gain_val = XCVR_RX_DIG_AGC_IDX2_GAIN_VAL_LOG_GAIN_2(0x026) |
                         XCVR_RX_DIG_AGC_IDX2_GAIN_VAL_MAG_THR_2(0x080) |
                         XCVR_RX_DIG_AGC_IDX2_GAIN_VAL_MAG_THR_HI_2(0x100),
    ...
    .agc_idx3_gain_val = XCVR_RX_DIG_AGC_IDX3_GAIN_VAL_LOG_GAIN_3(0x03C) |
                         XCVR_RX_DIG_AGC_IDX3_GAIN_VAL_MAG_THR_3(0x080) |
                         XCVR_RX_DIG_AGC_IDX3_GAIN_VAL_MAG_THR_HI_3(0x100),
    ...
    .agc_idx4_gain_val = XCVR_RX_DIG_AGC_IDX4_GAIN_VAL_LOG_GAIN_4(0x057) |
                         XCVR_RX_DIG_AGC_IDX4_GAIN_VAL_MAG_THR_4(0x080) |
                         XCVR_RX_DIG_AGC_IDX4_GAIN_VAL_MAG_THR_HI_4(0x100),
    ...
    .agc_idx5_gain_val = XCVR_RX_DIG_AGC_IDX5_GAIN_VAL_LOG_GAIN_5(0x06D) |
                         XCVR_RX_DIG_AGC_IDX5_GAIN_VAL_MAG_THR_5(0x080) |
                         XCVR_RX_DIG_AGC_IDX5_GAIN_VAL_MAG_THR_HI_5(0x100),
    ...
    .agc_idx6_gain_val = XCVR_RX_DIG_AGC_IDX6_GAIN_VAL_LOG_GAIN_6(0x087) |
                         XCVR_RX_DIG_AGC_IDX6_GAIN_VAL_MAG_THR_6(0x080) |
                         XCVR_RX_DIG_AGC_IDX6_GAIN_VAL_MAG_THR_HI_6(0x100),
    ...
    .agc_idx7_gain_val = XCVR_RX_DIG_AGC_IDX7_GAIN_VAL_LOG_GAIN_7(0x0A0) |
                         XCVR_RX_DIG_AGC_IDX7_GAIN_VAL_MAG_THR_7(0x080) |
                         XCVR_RX_DIG_AGC_IDX7_GAIN_VAL_MAG_THR_HI_7(0x100),
    ...
    .agc_idx8_gain_val = XCVR_RX_DIG_AGC_IDX8_GAIN_VAL_LOG_GAIN_8(0x0B7) |
                         XCVR_RX_DIG_AGC_IDX8_GAIN_VAL_MAG_THR_8(0x080) |
                         XCVR_RX_DIG_AGC_IDX8_GAIN_VAL_MAG_THR_HI_8(0x100),
    ...
    .agc_idx9_gain_val = XCVR_RX_DIG_AGC_IDX9_GAIN_VAL_LOG_GAIN_9(0x0D2) |
                         XCVR_RX_DIG_AGC_IDX9_GAIN_VAL_MAG_THR_9(0x080) |
                         XCVR_RX_DIG_AGC_IDX9_GAIN_VAL_MAG_THR_HI_9(0x100),
    ...
    .agc_timing0_drs = XCVR_RX_DIG_AGC_TIMING0_DRS_AGC_WBD_EN_DRS(0),
    ...
    .agc_timing2 = XCVR_RX_DIG_AGC_TIMING2_AGC_UNHOLD_GAIN_CHG(0) | XCVR_RX_DIG_AGC_TIMING2_AGC_UNHOLD_MAG_CNT(1) |
                   XCVR_RX_DIG_AGC_TIMING2_AGC_UNHOLD_MAG_SRC(1),

    /* CTRL0 configuration, dependencies: ['COM', 'COM', 'MD+DR', 'MD+DR', 'MD+DR', 'COM', 'COM', 'MD', 'COM', 'COM',
       'COM', 'COM', nan, 'COM'] */
    .ctrl0 = XCVR_RX_DIG_CTRL0_ADC_CLIP_EN(1) | XCVR_RX_DIG_CTRL0_CIC_CNTR_FREE_RUN_EN(0) |
    ...
    .ctrl1 = XCVR_RX_DIG_CTRL1_DC_RESID_EN(0) | XCVR_RX_DIG_CTRL1_DIS_WB_NORM_AA_FOUND(1) |
             ...
             XCVR_RX_DIG_CTRL1_RX_IQ_PH_AVG_WIN(0) | XCVR_RX_DIG_CTRL1_RX_IQ_PH_OUTPUT_COND(0) |
             XCVR_RX_DIG_CTRL1_RX_MIXER_IDX_OUT_MODE(0) | XCVR_RX_DIG_CTRL1_RX_NB_NORM_EN(1) |
             XCVR_RX_DIG_CTRL1_RX_SAMPLE_BUF_AUTO_GATE(0) | XCVR_RX_DIG_CTRL1_RX_SAMPLE_BUF_BYPASS(0) |
             XCVR_RX_DIG_CTRL1_RX_SAMPLE_BUF_BYPASS_IN_CTE(0),

    /* DCOC_CTRL0 configuration, dependencies: ['COM', 'COM', 'COM', 'COM', 'COM', 'COM', 'COM', 'MD+DR', 'COM', 'COM',
       'COM', 'COM', 'COM', 'COM', 'DR', 'DR', 'COM', 'COM', 'DR', 'DR'] */
    .dcoc_ctrl0 = XCVR_RX_DIG_DCOC_CTRL0_DCOC_ADC_OFFSET_OVRD_EN(0) | XCVR_RX_DIG_DCOC_CTRL0_DCOC_AVG_WIN(0) |
                  ...
                  XCVR_RX_DIG_DCOC_CTRL0_DCOC_DAC_OVRD_EN(0) | XCVR_RX_DIG_DCOC_CTRL0_DCOC_DIG_CORR_EN(0) |
...
/* RSSI_GLOBAL_CTRL configuration, dependencies: ['COM', 'COM', 'COM', 'COM', 'COM', 'COM', 'COM', 'COM', 'COM', 'COM',
 * 'COM', 'COM', 'COM', 'COM', 'COM'] */
#if defined(FFU_SMAC_REG_OFFSET_REQ)
    .rssi_global_ctrl =
...
#else
    .rssi_global_ctrl =
        0 | XCVR_RX_DIG_RSSI_GLOBAL_CTRL_NB_CCA1_ED_EN(0) | XCVR_RX_DIG_RSSI_GLOBAL_CTRL_NB_CONT_MEAS_OVRD(0) |
        XCVR_RX_DIG_RSSI_GLOBAL_CTRL_NB_CONT_MEAS_OVRD_EN(0) | XCVR_RX_DIG_RSSI_GLOBAL_CTRL_NB_RSSI_AA_MATCH_OVRD(0) |
        XCVR_RX_DIG_RSSI_GLOBAL_CTRL_NB_RSSI_AA_MATCH_OVRD_EN(0) | XCVR_RX_DIG_RSSI_GLOBAL_CTRL_NB_RSSI_EN(1) |
        XCVR_RX_DIG_RSSI_GLOBAL_CTRL_NB_RSSI_PA_AA_MATCH_SEL(1) | XCVR_RX_DIG_RSSI_GLOBAL_CTRL_NB_SNR_LQI_ENABLE(1),
#endif // defined(FFU_SMAC_REG_OFFSET_REQ)
    ...
    /* CTRL configuration, dependencies: ['COM', 'COM', 'COM', 'COM', 'COM', 'COM', 'COM', 'COM', 'COM', 'COM', 'COM',
       'COM', 'COM'] */
    .ctrl = XCVR_TSM_CTRL_BKPT(0xFF) | XCVR_TSM_CTRL_FORCE_RX_EN(0) | XCVR_TSM_CTRL_FORCE_TX_EN(0) |
            XCVR_TSM_CTRL_TSM_IRQ0_EN(0) | XCVR_TSM_CTRL_TSM_IRQ1_EN(0) | XCVR_TSM_CTRL_TSM_LL_INHIBIT(0) |
            XCVR_TSM_CTRL_TSM_SOFT_RESET(0) |
#if defined(FFU_SMAC_REG_OFFSET_REQ)
            XCVR_TSM_CTRL_ABORT_ON_CTUNE(0) | XCVR_TSM_CTRL_ABORT_ON_FREQ_TARG(0) | XCVR_TSM_CTRL_PLL_UNLOCK_IRQ_EN(0) |
            XCVR_TSM_CTRL_RX_ABORT_DIS(0) | XCVR_TSM_CTRL_TX_ABORT_DIS(0) |
#endif // defined(FFU_SMAC_REG_OFFSET_REQ)
            XCVR_TSM_CTRL_TSM_SPARE1_EXTEND(0x00),

    /* END_OF_SEQ configuration, dependencies: ['COM', 'COM', 'COM', 'COM'] */
    .end_of_seq = XCVR_TSM_END_OF_SEQ_END_OF_RX_WD(0x44) | XCVR_TSM_END_OF_SEQ_END_OF_RX_WU(0x42) |
                  XCVR_TSM_END_OF_SEQ_END_OF_TX_WD(0x4C) | XCVR_TSM_END_OF_SEQ_END_OF_TX_WU(0x4A),
...
/* FAST_CTRL1 configuration, dependencies: ['COM', 'COM', 'COM', 'COM', 'COM', 'COM', 'COM', 'COM', 'COM'] */
    ...
    .fast_ctrl1 = XCVR_TSM_FAST_CTRL1_FAST_RX2TX_EN(0) | XCVR_TSM_FAST_CTRL1_FAST_RX2TX_START(0x00) |
                  ...
                  XCVR_TSM_FAST_CTRL1_FAST_TX2RX_START(0x00) | XCVR_TSM_FAST_CTRL1_FAST_TX_WU_EN(0) |
                  XCVR_TSM_FAST_CTRL1_PWRSAVE_RX_WU_EN(0) | XCVR_TSM_FAST_CTRL1_PWRSAVE_TX_WU_EN(0) |
                  XCVR_TSM_FAST_CTRL1_PWRSAVE_WU_CLEAR(0),
#else
    .fast_ctrl1 = XCVR_TSM_FAST_CTRL1_FAST_RX2TX_EN(0) | XCVR_TSM_FAST_CTRL1_FAST_RX2TX_START(0x00) |
                  XCVR_TSM_FAST_CTRL1_FAST_TX2RX_EN(0) | XCVR_TSM_FAST_CTRL1_FAST_TX2RX_START(0x00) |
                  XCVR_TSM_FAST_CTRL1_PWRSAVE_RX_WU_EN(0) | XCVR_TSM_FAST_CTRL1_PWRSAVE_TX_WU_EN(0),
#endif // defined(FFU_SMAC_REG_OFFSET_REQ)
    ...
    .fast_ctrl3 = XCVR_TSM_FAST_CTRL3_FAST_RX2TX_START_FC(0xFF) | XCVR_TSM_FAST_CTRL3_FAST_TX2RX_START_FC(0x00),
    ...
    .timing11 = XCVR_TSM_TIMING11_PLL_DIG_EN_RX_HI(0x13) | XCVR_TSM_TIMING11_PLL_DIG_EN_RX_LO(0x59) |
                XCVR_TSM_TIMING11_PLL_DIG_EN_TX_HI(0x13) | XCVR_TSM_TIMING11_PLL_DIG_EN_TX_LO(0x4B),
    ...
    .timing13 = XCVR_TSM_TIMING13_TX_DIG_EN_PRE_TX_HI(0x45) | XCVR_TSM_TIMING13_TX_DIG_EN_PRE_TX_LO(0x4B),

    /* TIMING14 configuration, dependencies: ['COM', 'COM'] */
    .timing14 = XCVR_TSM_TIMING14_TX_DIG_EN_TX_HI(0x49) | XCVR_TSM_TIMING14_TX_DIG_EN_TX_LO(0x4B),
    ...
    .timing16 = XCVR_TSM_TIMING16_RX_INIT_RX_HI(0x40) | XCVR_TSM_TIMING16_RX_INIT_RX_LO(0x41),

    /* TIMING17 configuration, dependencies: ['COM', 'COM'] */
    .timing17 = XCVR_TSM_TIMING17_RX_DIG_EN_RX_HI(0x40) | XCVR_TSM_TIMING17_RX_DIG_EN_RX_LO(0x43),

    /* TIMING18 configuration, dependencies: ['COM', 'COM'] */
    .timing18 = XCVR_TSM_TIMING18_RX_PHY_EN_RX_HI(0x40) | XCVR_TSM_TIMING18_RX_PHY_EN_RX_LO(0x43),
    ...
    .timing44 = XCVR_TSM_TIMING44_SEQ_LO_PUP_VLO_RXDRV_RX_HI(0x12) |
                XCVR_TSM_TIMING44_SEQ_LO_PUP_VLO_RXDRV_RX_LO(0x59) |
...
#else
                           XCVR_TX_DIG_DATA_PADDING_CTRL_1_TX_DATA_FLUSH_DLY(0x06),
#endif // defined(FFU_SMAC_REG_OFFSET_REQ)
...
#else
               XCVR_TX_DIG_PA_CTRL_PA_TGT_POWER(0x3C) | XCVR_TX_DIG_PA_CTRL_TGT_PWR_SRC(1) |
#endif // defined(FFU_SMAC_REG_OFFSET_REQ)
...
#else
    .txdig_ctrl = XCVR_TX_DIG_TXDIG_CTRL_DATA_STREAM_SEL(1) | XCVR_TX_DIG_TXDIG_CTRL_INV_DATA_OUT(0),
#endif
    /***********************************************/
