...
#else
  RESERVED4_MODE  = 12, /*!< Reserved  */
  RESERVED5_MODE  = 13, /*!< Reserved  */
#endif /* defined(RADIO_IS_GEN_4P5) */
  NUM_RADIO_MODES = 14,
} radio_mode_t;
...
#if !defined(RADIO_IS_GEN_4P5) /* These exported values only apply to Gen 3.5 and Gen 4.0 */
 ...
 *
 * This function retrieves the current RSSI value.
 *
