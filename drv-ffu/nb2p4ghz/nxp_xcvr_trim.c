...
static xcvrTrimStatus_t IQMCCalcResult(xcvr_iqmc_trials_t *trials_data, uint8_t num_trials, uint32_t *iqmc_cal_ptr);
#endif /* !defined(GCOV_DO_COVERAGE) */
/*!
...
void dbg_ram_dc_capture(int16_t *buffer_ptr, uint16_t sz_bytes)
{
    ...
    static dbg_ram_trigger_config_t dc_trigger_config = {
        .out_sel     = DBG_RAM_OUT_DEMOD_CH_FILTER_SEL, /*!< Selection of IQ capture ooutput */
...
static xcvrTrimStatus_t IQMCCalcResult(xcvr_iqmc_trials_t *trials_data, uint8_t num_trials, uint32_t *iqmc_cal_ptr)
#else
xcvrTrimStatus_t IQMCCalcResult(xcvr_iqmc_trials_t *trials_data, uint8_t num_trials, uint32_t *iqmc_cal_ptr)
#endif /* !defined(GCOV_DO_COVERAGE) */
{
