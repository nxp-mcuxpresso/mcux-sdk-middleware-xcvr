...
typedef enum
{
    ...
    DBG_RAM_PAGE_RSVD1, /*!< Reserved. */
    DBG_RAM_PAGE_RSVD2, /*!< Reserved. */
    ...
    DBG_RAM_PAGE_RSVD3,      /*!< Reserved. */
    DBG_RAM_PAGE_RSVD4,      /*!< Reserved. */
...
typedef enum
{
    ...
    START_ON_PLL_UNLOCK      = 12, /*!< PLL unlock Start Trigger.  */
    START_ON_BLE_CRC_ERR_CNT = 13, /*!< BluetoothLE crc_err_count_incr Start Trigger.  */
#endif
